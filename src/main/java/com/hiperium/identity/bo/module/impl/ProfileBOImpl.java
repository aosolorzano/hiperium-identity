...
public class ProfileBOImpl extends GenericBO implements ProfileBO {
	 ...
	 */
	@Override
	public List<SelectionDTO> findByHomeId(@NotNull @Min(value = 1L) Long homeId, @NotNull @Min(value = 1L) Long userId, 
			@NotNull String tokenId) {
		return super.getDaoFactory().getProfileDAO().findByHomeId(userId, homeId);
	}
