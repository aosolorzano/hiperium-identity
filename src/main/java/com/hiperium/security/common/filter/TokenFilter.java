 ...
 * 
 */
package com.hiperium.security.common.filter;
...
public class TokenFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) 
		...
		if(!(path.endsWith(RestSecurityPath.IS_USER_LOGGED_IN) || 
				path.endsWith(RestSecurityPath.USER_AUTH) || 
				path.endsWith(RestSecurityPath.HOME_AUTH))) {
